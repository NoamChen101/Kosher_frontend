...
return returnArr.length>1?returnArr:returnArr[0];};$.fn.carousel.defaults={hAlign:'center',vAlign:'center',hMargin:0.5,vMargin:0.2,left:0,right:0,top:0,bottom:0,backZoom:0.9,slidesPerScroll:3,speed:500,buttonNav:'none',directionNav:false,autoplay:true,autoplayInterval:3000,pauseOnHover:true,mouse:true,shadow:false,reflection:false,reflectionHeight:0.3,reflectionOpacity:0.5,reflectionColor:'255,255,255',description:false,descriptionContainer:'.description',backOpacity:1,before:function(carousel){},after:function(carousel){}};})(jQuery);